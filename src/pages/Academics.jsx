    ...
    <div className="pb-20 bg-white">
      ...
      <section className="relative h-[55vh] min-h-[400px] flex items-center justify-center overflow-hidden">
         ...
         <div className="relative z-10 text-center text-white px-4">
             ...
             >
                 Rigorous programs designed to prepare students for national exams and university.
             </motion.p>
         </div>
      </section>
      ...
      <section className="section-padding">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="w-full md:w-1/2 space-y-6">
            <h2 className="text-3xl font-bold">Ordinary Level (O-Level)</h2>
            <p className="text-slate-600 leading-relaxed text-lg">
              Our O-Level program (Senior 1 to Senior 3) follows the national curriculum, emphasizing a broad foundation in sciences, humanities, and languages.
            </p>
          ...
          <div className="w-full md:w-1/2 p-6 md:p-12 bg-slate-50 rounded-[3rem] border border-slate-100 relative">
            ...
            <div className="pt-12">
               <h4 className="text-2xl font-bold text-school-blue mb-4">Focus on Fundamentals</h4>
               <p className="text-lg text-slate-600 leading-relaxed italic border-l-4 border-school-green pl-6">"We ensure our students master the basics before specializing in A-Level. A strong foundation builds a skyscraper."</p>
            </div>
          </div>
        </div>
      </section>
