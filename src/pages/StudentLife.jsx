    ...
    <div className="pb-20 bg-white">
      ...
      <section className="relative h-[55vh] min-h-[400px] flex items-center justify-center overflow-hidden">
         ...
         <div className="relative z-10 text-center text-white px-4">
             ...
             >
               {replaceSchoolName(t('studentLifeHeroSubtitle'))}
             </motion.p>
         </div>
      </section>
      ...
      <section id="activities" className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-slate-800">{t('studentLifeActivitiesTitle')}</h2>
          <p className="text-slate-500 mt-2">{t('studentLifeGalleryNote')}</p>
