...
const HeroSlideshow = ({ slides }) => {
  ...
  const replaceSchoolName = (text) => typeof text === 'string' ? text.replace('{schoolName}', siteContent?.general?.schoolName || '') : text;
  if (!slides || slides.length === 0 || !siteContent) return null;
...
const Home = () => {
  ...
  const { siteContent } = useAuth();
  const { t } = useTranslation();
  const heroSlides = t('homeHeroSlides') || [];
  const replaceSchoolName = (text) => typeof text === 'string' ? text.replace('{schoolName}', siteContent?.general?.schoolName || '') : text;
  ...
  const homeFacilities = Array.isArray(t('homeFacilities')) ? t('homeFacilities') : (home.about?.facilities || []);
    ...
    <div className="flex flex-col">
      ...
      <section className="section-padding bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 relative z-10">
          ...
          >
            ...
            <h3 className="text-2xl font-black text-slate-800 mb-4">{t('homeHighlightsHeading1')}</h3>
            <p className="text-slate-500 leading-relaxed">
              {t('homeHighlightsText1')}
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-2xl font-black text-slate-800 mb-4">{t('homeHighlightsHeading2')}</h3>
            <p className="text-slate-500 leading-relaxed">
              {t('homeHighlightsText2')}
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-2xl font-black text-slate-800 mb-4">{t('homeHighlightsHeading3')}</h3>
            <p className="text-slate-500 leading-relaxed">
              {t('homeHighlightsText3')}
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <div>
              <span className="text-school-green font-bold tracking-widest uppercase text-sm flex items-center gap-2 mb-3">
                ...
                {replaceSchoolName(t('homeDiscoverSchool'))}
              </span>
            ...
            <p className="text-slate-600 leading-relaxed text-lg">
              {replaceSchoolName(t('homeLegacyText1'))}
            </p>
            <p className="text-slate-600 leading-relaxed text-lg mt-6">
              {replaceSchoolName(t('homeLegacyText2'))}
            </p>
            ...
            <div className="mt-6 border border-slate-300 p-5 bg-white shadow-sm rounded">
              ...
              <p className="font-bold underline mb-2">{t('homeFacilitiesInclude')}</p>
            ...
            >
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-slate-800 leading-relaxed text-lg font-medium italic">
                  "I am truly grateful for the strong education I received at {siteContent.general.schoolName}. It gave me the confidence to dive into technology and grow my skills to reach university level. 
                </p>
      ...
      <section className="relative py-28 border-t-8 border-school-green/10 flex items-center justify-center overflow-hidden">
        ...
        <motion.div 
          ...
          className="relative z-10 text-center px-6 max-w-4xl mx-auto"
        >
          <span className="text-school-green text-xs font-black uppercase tracking-[0.4em] mb-6 block">{t('homeFutureReadyTag')}</span>
          ...
          <p className="text-xl md:text-2xl text-slate-300 font-light mb-12 leading-relaxed">
            {replaceSchoolName(t('homeMissionDesc'))}
          </p>
          <motion.div
          ...
          >
            <Link to="/contact#contact-form" className="inline-flex items-center gap-4 bg-school-green text-white px-12 py-6 font-black text-lg uppercase tracking-widest rounded-full hover:bg-green-500 transition-all shadow-[0_20px_40px_rgba(34,197,94,0.4)]">
              {t('homeApplyNow')} <ArrowRight size={24} />
            </Link>
          </motion.div>
        </motion.div>
      </section>
